...
class Comfy::Admin::Cms::FilesControllerTest < ActionController::TestCase
  ...
  def test_get_index_with_category
    get :index, params: { :site_id => @site, :category => comfy_cms_categories(:default).label }
    assert_response :success
    assert assigns(:files)
  ...
  def test_get_index_with_redactor_images
    ...
    get :index, params: { :site_id => @site, :source => 'redactor', :type => 'image' }
    assert_response :success
  ...
  def test_get_index_with_redactor_files
    ...
    get :index, params: { :site_id => @site, :source => 'redactor', :type => 'file' }
    assert_response :success
  ...
  def test_get_edit
    get :edit, params: { :site_id => @site, :id => @file }
    assert_response :success
    assert assigns(:file)
  ...
  def test_get_edit_failure
    get :edit, params: { :site_id => @site, :id => 'not_found' }
  ...
  def test_create_as_plupload_failure
    assert_no_difference 'Comfy::Cms::File.count' do
      post :create, params: { :source => 'plupload', :site_id => @site, :file => { } }
  ...
  def test_create_as_redactor_failure
    assert_no_difference 'Comfy::Cms::File.count' do
      post :create, params: { :source => 'redactor', :site_id => @site, :file => { } }
      assert_response :unprocessable_entity
    end
  end
  ...
  def test_destroy
    assert_difference 'Comfy::Cms::File.count', -1 do
      delete :destroy, params: { :site_id => @site, :id => @file }
      assert_response :redirect
      assert_redirected_to :action => :index
  ...
  def test_destroy_as_xhr
    assert_difference 'Comfy::Cms::File.count', -1 do
      delete :destroy, params: { :site_id => @site, :id => @file }, xhr: true
      assert_response :success
    end
  end
  ...
  def test_reorder
    ...
    put :reorder, params: { :site_id => @site, :comfy_cms_file => [file_two.id, file_one.id] }
    assert_response :success
    file_one.reload
    file_two.reload
